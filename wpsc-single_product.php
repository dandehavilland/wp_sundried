...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					...
					<div class="productcol">			
  					...
  					<div class="wpsc_product_price">
  						...
  						<?php else : ?>
  							...
  							<span class="pricedisplay <?php echo wpsc_the_product_id(); ?>"><del><?php echo wpsc_product_normal_price(); ?></del></span></span>
  							<?php endif; ?>
  							<span class="pricedisplay <?php echo wpsc_the_product_id(); ?>"><span id='product_price_<?php echo wpsc_the_product_id(); ?>' class="currentprice pricedisplay"><?php echo wpsc_the_product_price(); ?></span></span>
  							<?php if(wpsc_product_on_special()) : ?>
  							<span class="pricedisplay saved product_<?php echo wpsc_the_product_id(); ?>"><span class="yousave" id="yousave_<?php echo wpsc_the_product_id(); ?>">save <?php echo wpsc_currency_display(wpsc_you_save('type=amount'), array('html' => false)); ?></span></span>
  							<?php endif; ?>
  							 <!-- multi currency code -->
						...
						<form class="product_form" enctype="multipart/form-data" action="<?php echo wpsc_this_page_url(); ?>" method="post" name="1" id="product_<?php echo wpsc_the_product_id(); ?>">
						  ...
						  <table>
							...
							<?php if ( wpsc_product_has_personal_text() ) : ?>
							  <tr class="custom_text">
									<th width="180" colspan="2">
									  <?php _e( 'Personalize Your Product', 'wpsc' ); ?>
									  <textarea cols='29' rows='5' name="custom_text"></textarea>
									</th>
								</tr>
							<?php endif; ?>
						
							<?php if ( wpsc_product_has_supplied_file() ) : ?>
								<tr class="custom_file">
									<th colspan="2" width="180">
									  <?php _e( 'Upload a File', 'wpsc' ); ?>
             ...
             <?php if (wpsc_have_variation_groups()) { ?>
               <tr>
                 <th width="180"><?php _e('Product Options', 'wpsc'); ?></th>
						      <td><div class="wpsc_variation_forms">
                        	<table>
            ...
            <tr>
              ...
              <tr>
                <th width="180"><?php _e('Quantity', 'wpsc'); ?></th>
                <td>
							...
							<tr>
							  <th width="180">Send to a friend</th>
							  <td><div class="st_sharethis" displayText="ShareThis"></div></td>
							</tr>
							<?php endif; ?>
							<!--end sharethis-->
